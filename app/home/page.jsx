    ...
    <section className="relative font-manrope" style={divStyle}>
      ...
      <div className="relative lg:ml-20 w-full px-4 py-32 pt-36 sm:px-6 lg:flex lg:h-screen 2xl:h-[1440px] lg:items-center lg:px-8">
        <div className="text-center md:text-left">
          <h1 className="w-full text-3xl sm:text-4xl md:text-5xl font-extrabold lg:text-6xl xl:text-7xl 2xl:text-[8.5rem]">
            Your <span className="text-primary-green">Home</span> Away <br />{" "}
            from
            <span className="text-primary-green pl-2">Home.</span>
          </h1>

          <p className="2xl:my-4 w-11/12 mx-auto md:mr-auto sm:w-2/3 lg:w-3/5 lg:m-4 my-4 md:mb-0 md:mx-0 text-base sm:text-lg/relaxed md:text-[1.3rem] lg:text-[1.4rem] xl:text-[1.5rem] 2xl:text-5xl 2xl:leading-[5rem] md:border-l-2 md:border-primary-green md:pl-4">

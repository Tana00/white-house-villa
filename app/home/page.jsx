...
const Home = () => {
  ...
  return (
    <section
      ...
      style={divStyle}
    >
      <div className="absolute inset-0 bg-[#F3FBF7] sm:bg-transparent sm:from-[#F3FBF7] sm:via-[#F3FBF7]/90 sm:to-[#F3FBF700]/0 sm:bg-gradient-to-r"></div>
      <div className="relative lg:ml-20 w-full px-4 py-32 pt-36 sm:px-6 lg:flex lg:h-screen 2xl:h-[1440px] lg:items-center lg:px-8">
        <div className="text-center md:text-left">
          <h1 className="w-full text-4xl md:text-5xl font-extrabold lg:text-6xl xl:text-7xl 2xl:text-[8.5rem]">
            Your <span className="text-primary-green">Home</span> Away <br />{" "}
            from
            <span className="text-primary-green pl-2">Home.</span>
          </h1>

          <p className="2xl:my-4 w-full mx-auto md:mr-auto sm:w-2/3 lg:w-3/5 lg:m-4 my-4 md:mb-0 md:mx-0 sm:text-lg/relaxed md:text-[1.3rem] lg:text-[1.4rem] xl:text-[1.5rem] 2xl:text-5xl 2xl:leading-[5rem] md:border-l-2 md:border-primary-green md:pl-4">
          ...
          <div className="m-8 md:mb-0 md:mx-0 mx-auto md:mr-auto flex flex-wrap gap-4 text-center w-2/3 md:w-[256px] lg:w-[400px] 2xl:w-[650px]">
            <a
              href="/#explore"
              target="_blank"
              className="block w-full rounded-md bg-primary-green px-12 py-3.5 2xl:px-40 2xl:py-10 text-sm md:text-lg xl:text-xl 2xl:text-3xl font-medium text-white shadow hover:bg-transparent hover:text-primary-green focus:outline-none focus:ring"
            >
              View Property
            </a>
          </div>

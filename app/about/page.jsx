...
const About = () => {
  return (
    <div className="flex flex-col mb-14 h-screen items-center justify-start bg-[#F7F7F7]">
      {/*  Headline text */}
      <div className=" flex flex-1 md:w-4/5 h-max md:px-20 px-4 flex-col gap-6 items-center justify-center text-center text-[#040C07]">
      ...
      <div className=" flex flex-1 flex-col gap-8 md:w-4/5 mt-[-50px] justify-center items-center text-center bg-white rounded-md py-4 px-8">
        ...
        <p className="home-text text-[1.125rem] mt-[-30px] text-[#484848]">
          Explore a diverse range of accommodations, from cozy apartments in
          bustling cities to remote cabins nestled in nature. Our user-friendly
          search and filter options make finding your dream stay a breeze.
        </p>
        <Link href="/#explore">

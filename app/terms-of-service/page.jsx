  ...
  return (
    <>
      <section id="terms_of_service">
        ...
        <div className="my-20 md:mx-auto w-5/6">
          <h2>
            <strong>Terms and Conditions</strong>
          </h2>

          <p>Welcome to White House Villa!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of White House Villa's Website, located at
            https://white-house-villa.vercel.app/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use White House Villa if you do not
          ...
          <p>
            We employ the use of cookies. By accessing White House Villa, you
            agreed to use cookies in agreement with the White House Villa's
            Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, White House Villa and/or its licensors own
            the intellectual property rights for all material on White House
            Villa. All intellectual property rights are reserved. You may access
            this from White House Villa for your own personal use subjected to
            restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from White House Villa</li>
            <li>Sell, rent or sub-license material from White House Villa</li>
            <li>
              Reproduce, duplicate or copy material from White House Villa
            </li>
            <li>Redistribute content from White House Villa</li>
          </ul>

          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            White House Villa does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of White House Villa,its agents and/or
            ...
            applicable laws, White House Villa shall not be liable for the
          ...
          <p>
            White House Villa reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant White House Villa a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of White House
            Villa; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to White House Villa. Please include your name,
          ...
          <p>
            No use of White House Villa's logo or other artwork will be allowed

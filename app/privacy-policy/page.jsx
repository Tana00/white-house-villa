    ...
    <>
      <section id="terms_of_service">
        ...
        <div className="my-20 md:mx-auto w-5/6">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to White House Villa, Mapperly United
                Kingdom.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to White House Villa, accessible
                from{" "}
                <a
                  href="https://white-house-villa.vercel.app/"
          ...
          <ul>
            <li>
              <p>By email: whitehousevilla23@gmail.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://white-house-villa.vercel.app/#contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://white-house-villa.vercel.app/#contact
                </a>
              </p>
            </li>
          </ul>

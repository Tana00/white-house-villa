...
const HowItWorks = () => {
  return (
    <div className="w-full h-full lg:h-screen flex flex-col justify-center items-center lg:mt-[120px] mt-0 bg-white">
      <div className="lg:w-11/12 lg:h-[90vh] mx-auto md:p-8 p-4 flex flex-col lg:flex-row justify-center items-center bg-[#F3FBF7] rounded-md">

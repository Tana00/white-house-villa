...
const HowItWorks = () => {
  return (
    <div className="w-full h-full lg:h-screen flex flex-col justify-center items-center lg:pt-[120px] pt-0 bg-white">
      <div className="lg:w-11/12 mx-auto md:p-8 p-4 flex flex-col lg:flex-row justify-center items-start bg-[#F3FBF7] rounded-md">
        <div className="flex flex-1 flex-col gap-3 mt-0 md:mt-10">
          <div className="md:mx-8 md:px-8 text-center md:text-left">
            <h1 className="text-3xl md:text-[2.5rem] leading-[64px] font-bold text-[#226E46]">
              How it works
            </h1>
            <p className="text-[#040C07] text-base md:text-[1.125rem] md:leading-8 md:my-4">
              We've designed our process to be straightforward and
              user-friendly, ensuring a seamless experience for our customers.
              Here's how it all works:
            </p>
          </div>
          <div className="grid grid-cols-2 mt-4 md:mx-12 sm:mx-4 font-medium">
